...
class PembelianBarangMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.PembelianBarangMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('pembelian_barang');
		$tMap->setPhpName('PembelianBarang');
