...
abstract class BasePenjualanBarang extends BaseObject  implements Persistent {
	...
	public function setIdPembelian($v)
	{
		...
		if ($this->id_pembelian !== $v) {
			$this->id_pembelian = $v;
			$this->modifiedColumns[] = PenjualanBarangPeer::ID_PEMBELIAN;
		}
	...
	public function setIdBarang($v)
	{
		...
		if ($this->id_barang !== $v) {
			$this->id_barang = $v;
			$this->modifiedColumns[] = PenjualanBarangPeer::ID_BARANG;
		}
	...
	public function setJumlah($v)
	{
		...
		if ($this->jumlah !== $v) {
			$this->jumlah = $v;
			$this->modifiedColumns[] = PenjualanBarangPeer::JUMLAH;
		}
	...
	public function setHarga($v)
	{
		...
		if ($this->harga !== $v) {
			$this->harga = $v;
			$this->modifiedColumns[] = PenjualanBarangPeer::HARGA;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PenjualanBarangPeer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating PenjualanBarang object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			PenjualanBarangPeer::doDelete($this, $con);
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aBarang !== null) {
				...
				$this->setBarang($this->aBarang);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PenjualanBarangPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += PenjualanBarangPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PenjualanBarangPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PenjualanBarangPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PenjualanBarangPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PenjualanBarangPeer::ID_PEMBELIAN)) $criteria->add(PenjualanBarangPeer::ID_PEMBELIAN, $this->id_pembelian);
		if ($this->isColumnModified(PenjualanBarangPeer::ID_BARANG)) $criteria->add(PenjualanBarangPeer::ID_BARANG, $this->id_barang);
		if ($this->isColumnModified(PenjualanBarangPeer::JUMLAH)) $criteria->add(PenjualanBarangPeer::JUMLAH, $this->jumlah);
		if ($this->isColumnModified(PenjualanBarangPeer::HARGA)) $criteria->add(PenjualanBarangPeer::HARGA, $this->harga);
		if ($this->isColumnModified(PenjualanBarangPeer::ID)) $criteria->add(PenjualanBarangPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PenjualanBarangPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new PenjualanBarangPeer();
		}
		return self::$peer;
	}
